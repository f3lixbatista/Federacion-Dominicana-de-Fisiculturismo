...
router.get('/', checkPermiso('inscripcion', 'editar'), inscripcionController.inscripcionPage);
...
router.post('/guardar-asistida', checkPermiso('inscripcion', 'editar'), inscripcionController.guardarInscripcionAsistida);
